...
var apiHelper = {
    ...
    //urlBase: 'http://192.168.1.16:5329/api',//后台api地址
    //urlBase: 'http://localhost:5329/api',//后台api地址
    //urlBase:'http://192.168.3.97:5329/api',
    urlHost:'http://localhost:5329/',
    ...
    deletePumpInfo: function (IDStr, callback) {
        var vurl = this.urlBase + "/pump-house/" + IDStr;
        $.ajax({
            type: "DELETE",
            url: vurl,
            async: false,
    ...
    pumpHouseAutoComplate: function (CompanyId, searchKey, resultCount, callback) {
        var vurl = "";
        if (searchKey == '')
            vurl = this.urlBase + "/pump-house/auto-complate/" + resultCount + "?CompanyId=11";
        else
            vurl = this.urlBase + "/pump-house/auto-complate/" + resultCount + "?CompanyId=11&where=" + searchKey;
        console.log(vurl);
        $.ajax({
            type: "GET",
            url: vurl,
    ...
    seedInfoAutoComplate: function (CompanyId, searchKey, resultCount, callback) {
        var vurl = "";
        if (searchKey == '')
            vurl = this.urlBase + "/seed-info/auto-complate/" + resultCount + "?CompanyId=11";
        else
            vurl = this.urlBase + "/seed-info/auto-complate/" + resultCount + "?CompanyId=11&where=" + searchKey;
        console.log(vurl);
        $.ajax({
            type: "GET",
            url: vurl,
    ...
    queryAllSeedInfoByCompanyId: function (companyId, Year, callback) {
        var vurl = this.urlBase + "/seed-info/11/" + Year;
        console.log("queryAllSeedInfoByCompanyId");
        console.log(vurl);
        $.ajax({
            type: "GET",
            url: vurl,
    ...
    getGrowthInfoAllYear: function (companyId, callback) {
        var vurl = this.urlBase + "/growth-info/allYear/11";
        $.ajax({
            type: "GET",
            url: vurl,
            async: false,
    ...
    InitMobilePage: function (parm, callback) {
        var vurl = this.urlBase + "/mobile/mobilePageData?companyId=11&year=" + parm.year + "&cropsId="+ parm.cropsId + "&pumpHouseID=" + parm.pumpHouseID;
    ...
    addPumpHouse: function (requestData, callback) {
        var vurl = this.urlBase + "/pump-house";
        console.log("addPumpHouse");
    ...
    editPumpHouse: function (pumpHouseId,requestData,callback)
    {
        var vurl = this.urlBase + "/pump-house/" + pumpHouseId;
        console.log("editPumpHouse");
        console.log(requestData);
        console.log(vurl);
        $.ajax({
            type: "PUT",
    ...
    )
    {
        ...
        var vurl = this.urlBase + "/company-info/page?" + this.getQueryString(queryParm);
        $.ajax({
            type: "get",
            url: vurl,
            async: false,
    ...
    saveCompanyInfo: function (saveData, saveMethod, callback) {
